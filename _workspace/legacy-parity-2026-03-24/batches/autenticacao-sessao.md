...
Commits: 3
Date range: 2026-03-30..2026-04-13
...
### adc91efd3 - Usa token da sessao no limpar cache
...
### 65d925106 - Remoção do Console log para exibição do token
...
### 5c4500027 - fix: exibir modal de desconexao no erro do ui-bootstrap
