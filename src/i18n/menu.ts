...
const MENU_KEY_ALIASES: Record<string, string> = {
  ...
  'relatorios-v2': 'relatorios-list',
  'relatorios-v2-list': 'relatorios-list',
  'configuracoes-ia-form': 'assistente-virtual',
  'chatbot-empresa-form': 'assistente-vendas-ia',
  'cadastro-parametros-list': 'parametros',
  'cadastro-parametros-form': 'parametros',
  'parametros-empresa-list': 'parametros',
  'chatbot-empresas-list': 'assistente-vendas-ia',
