...
export const EMPRESAS_CONFIG: CrudModuleConfig = {
  ...
  columns: [
    ...
    { id: 'codigo', labelKey: 'simpleCrud.fields.code', label: 'Código', sortKey: 'codigo', thClassName: 'w-[110px]', filter: { kind: 'text', key: 'codigo' } },
    {
      id: 'cnpj',
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'id_cluster', labelKey: 'rootCompanies.fields.cluster', label: 'Cluster', type: 'select', optionsResource: 'clusters', required: true },
        ...
        { key: 'id_template', labelKey: 'rootCompanies.fields.template', label: 'Template de integração', type: 'select', optionsResource: 'templates_integracao', required: true },
        ...
        { key: 'id_implantacao_gerente', labelKey: 'rootCompanies.fields.implementationManager', label: 'Gerente de implantação', type: 'select', optionsResource: 'administradores_master' },
        { key: 'id_implantacao_analista', labelKey: 'rootCompanies.fields.implementationAnalyst', label: 'Analista de implantação', type: 'select', optionsResource: 'administradores_master' },
