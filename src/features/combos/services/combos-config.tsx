  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'imagem', labelKey: 'marketing.combos.fields.image', label: 'Imagem', type: 'image', uploadProfileId: 'tenant-public-images', uploadFolder: 'combos' },
        { key: 'imagem_mobile', labelKey: 'marketing.combos.fields.mobileImage', label: 'Imagem mobile', type: 'image', uploadProfileId: 'tenant-public-images', uploadFolder: 'combos' },
