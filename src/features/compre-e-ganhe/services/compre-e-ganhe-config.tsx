  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'imagem', labelKey: 'marketing.buyAndGet.fields.image', label: 'Imagem', type: 'image' },
        { key: 'imagem_mobile', labelKey: 'marketing.buyAndGet.fields.mobileImage', label: 'Imagem mobile', type: 'image' },
      ],
    },
  ],
