  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'id_tabela_canal_distribuicao', labelKey: 'people.registrationRules.fields.channelPriceTable', label: 'Tabela de preço x canal de distribuição', type: 'lookup', optionsResource: 'canais_distribuicao', lookupStateKey: 'id_tabela_canal_distribuicao_lookup' },
      ],
    },
  ],
  formEmbed: 'filial,filial_pedido,filial_estoque,vendedor,praca,tabela_preco,canal_distribuicao,cliente_filial,tabela_preco_filial,cliente_canal_distribuicao,tabela_canal_distribuicao',
