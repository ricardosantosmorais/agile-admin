...
export const COLECOES_CONFIG: CrudModuleConfig = {
  ...
  defaultFilters: { page: 1, perPage: 15, orderBy: 'nome', sort: 'asc', id: '', codigo: '', 'nome::like': '', id_filial: '', restrito: '', ativo: '' },
  columns: [
    ...
    { id: 'id_filial', labelKey: 'catalog.colecoes.fields.branch', label: 'Filial', sortKey: 'id_filial', thClassName: 'w-[180px]', render: (record) => String((record.filial as { nome_fantasia?: string; nome?: string } | undefined)?.nome_fantasia || (record.filial as { nome?: string } | undefined)?.nome || record.id_filial || '-'), filter: { kind: 'text', key: 'id_filial' } },
    {
      id: 'restrito',
  ...
  sections: [
    {
      ...
      fields: [
        ...
        { key: 'selo', labelKey: 'catalog.fields.seal', label: 'Selo', type: 'image' },
