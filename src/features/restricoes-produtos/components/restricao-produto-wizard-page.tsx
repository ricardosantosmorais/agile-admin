                      ...
                      <div className="mt-3">
                        <AppDataTable
                          ...
                          columns={[
                            {
                              id: 'audience',
                              label: t('maintenance.productRestrictions.steps.audience', 'P\u00fablico-alvo'),
                              cell: (row) => row.audience,
                              tdClassName: 'font-medium text-[color:var(--app-text)]',
                            },
                            {
                              id: 'product',
                              label: t('maintenance.productRestrictions.steps.products', 'Produtos'),
                              cell: (row) => row.product,
                              tdClassName: 'text-[color:var(--app-muted)]',
                            },
                          ]}
                          emptyMessage={t('maintenance.productRestrictions.emptyPreview', 'Nenhuma combina\u00e7\u00e3o gerada.')}
                          mobileCard={{
