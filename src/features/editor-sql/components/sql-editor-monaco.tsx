...
export function SqlEditorMonaco({
  ...
  return (
    <div
      ...
      className="flex h-full min-h-0 flex-col overflow-hidden rounded-[1.2rem] border border-[#e8e2d7] bg-[#fbfaf7]"
