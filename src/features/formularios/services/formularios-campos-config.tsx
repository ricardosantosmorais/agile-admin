...
export const FORMULARIOS_CAMPOS_CONFIG: CrudModuleConfig = {
  ...
  columns: [
    ...
    { id: 'titulo', labelKey: 'maintenance.formFields.fields.title', label: 'Título', sortKey: 'titulo', tdClassName: 'font-semibold text-[color:var(--app-text)]', filter: { kind: 'text', key: 'titulo::like' } },
    {
      id: 'tipo',
