...
export const dashboardTooltips = {
	comercialRoot: {
		regraOficial: {
			...
			descricao: 'Os pedidos são considerados pela data do pedido e classificados pelo status atual, usando a mesma regra comercial do dashboard da empresa.',
			statusRealizados: [
				'recebido',
				'em_analise',
			...
			observacao: 'Status fora da regra comercial aparecem na distribuição geral por status, mas não entram nos KPIs de receita, pedidos, ticket, rankings, concentração ou empresas sem venda.',
		},
		receitaRealizada: {
			titulo: 'Receita realizada',
			descricao: 'Soma dos pedidos cuja data está no período selecionado e cujo status atual entra na regra comercial usada também no dashboard da empresa.',
		},
		pedidosRealizados: {
			titulo: 'Pedidos realizados',
			descricao: 'Quantidade de pedidos cuja data está no período selecionado e cujo status atual entra na regra comercial usada também no dashboard da empresa.',
		},
