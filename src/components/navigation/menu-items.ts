...
const ROOT_MENU: LegacyRootDefinition[] = [
  ...
  { key: 'chatbot-empresas-list', label: 'Assistente de Vendas IA', icon: Bot, component: 'chatbot-empresas-list' },
  { key: 'changelog-list', label: 'Atualizacoes Gerais', icon: History, component: 'changelog-list' },
  {
    ...
    icon: Network,
    children: [
      { key: 'infraestrutura-servidores-api-list', label: 'Servidores de API', icon: MonitorCog, component: 'infraestrutura-servidores-api-list' },
    ],
  },
  {
    key: 'integracao-erp',
...
function buildStandardExtras(session: AuthSession, locale: Locale): MenuItem[] {
  ...
  if (session.user.master) {
    items.push({
      ...
      children: [
        { key: 'tools-dictionary', label: translateMenuLabel(locale, 'tools-dictionary', LEGACY_EXTRA_COMPONENTS.toolsDictionary.label), icon: LEGACY_EXTRA_COMPONENTS.toolsDictionary.icon, ...resolveExtraRoute(LEGACY_EXTRA_COMPONENTS.toolsDictionary, tenant) },
        { key: 'tools-editor-sql', label: translateMenuLabel(locale, 'tools-editor-sql', LEGACY_EXTRA_COMPONENTS.toolsEditorSql.label), icon: LEGACY_EXTRA_COMPONENTS.toolsEditorSql.icon, ...resolveExtraRoute(LEGACY_EXTRA_COMPONENTS.toolsEditorSql, tenant) },
        { key: 'tools-http-client', label: translateMenuLabel(locale, 'tools-http-client', LEGACY_EXTRA_COMPONENTS.toolsHttpClient.label), icon: LEGACY_EXTRA_COMPONENTS.toolsHttpClient.icon, ...resolveExtraRoute(LEGACY_EXTRA_COMPONENTS.toolsHttpClient, tenant) },
        { key: 'tools-implantacao', label: translateMenuLabel(locale, 'tools-implantacao', LEGACY_EXTRA_COMPONENTS.toolsImplantacao.label), icon: LEGACY_EXTRA_COMPONENTS.toolsImplantacao.icon, ...resolveExtraRoute(LEGACY_EXTRA_COMPONENTS.toolsImplantacao, tenant) },
      ],
    })
  }
