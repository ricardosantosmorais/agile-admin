...
const IMPLEMENTED_COMPONENT_ROUTES: Record<string, string> = {
	...
	'atendimentos-list': '/meus-atendimentos',
	'atendimentos-intercom-config': '/meus-atendimentos/vinculo-intercom',
	...
	'catalogos-studio': '/catalogos-digitais',
	'catalogos-digitais': '/catalogos-digitais',
	'catalogos-digitais-list': '/catalogos-digitais',
	...
	'parametros-erp-form': '/integracao-com-erp/parametros',
	'imagens-erp-form': '/integracao-com-erp/imagens',
