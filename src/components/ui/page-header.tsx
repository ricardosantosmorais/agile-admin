...
export function PageHeader({ title, actions, breadcrumbs }: PageHeaderProps) {
	...
	return (
		<div className="app-shell-card-modern rounded-[1.45rem] px-5 py-1.5 md:px-6">
			<div className="flex flex-col gap-2 md:min-h-[52px] md:flex-row md:items-center md:justify-between">
