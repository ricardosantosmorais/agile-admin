...
const CRUD_OPTIONS_PATHS: Record<CrudResource, string> = {
	...
	componentes_campos: '/api/componentes-campos',
	relatorios: '/api/relatorios-master',
	'relatorios/grupos': '/api/relatorios-grupos',
	'implantacao/categorias_tarefas': '/api/categorias-tarefas',
	'implantacao/tarefas': '/api/tarefas',
	fases: '/api/lookups/fases',
	categorias_tarefas: '/api/lookups/categorias_tarefas',
	agilesync_empresas: '/api/lookups/agilesync_empresas',
	emails_payloads: '/api/emails-payloads',
	apps: '/api/apps',
	...
	notificacoes_painel: '/api/notificacoes-painel',
	linhas: '/api/linhas',
	cores: '/api/cores',
	...
	gateways: '/api/erp-cadastros/gateways',
	gateways_endpoints: '/api/erp-cadastros/gateway-endpoints',
	interfaces_consulta: '/api/erp-cadastros/interfaces-consulta',
	acoes: '/api/erp-cadastros/acoes',
	servicos_cadastros: '/api/erp-cadastros/servicos',
...
export function createCrudClient(basePath: string): CrudDataClient {
	return {
		...
		async listOptions(resource: CrudResource) {
			...
			const query = basePath.startsWith('/api/lookups/') ? '?page=1&perPage=1000&q=' : `?page=1&perPage=1000&orderBy=${orderBy}&sort=asc`;
