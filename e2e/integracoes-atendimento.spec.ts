...
test.describe('Integrações > Atendimento', () => {
  test('carrega configurações e salva alterações de WhatsApp', async ({ page }) => {
    ...
    await page.goto('/integracoes/atendimento', {
    ...
    await expect(page.getByText(/Última alteração: 2026-04-09 10:00:00 por Admin Master|Last update: 2026-04-09 10:00:00 by Admin Master/i)).toBeVisible()

    const branchNumberInput = page.locator('tbody tr').first().locator('input').nth(0)
    await branchNumberInput.fill('(11) 98888-7777')
